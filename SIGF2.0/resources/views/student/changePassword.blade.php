                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/changePassword/'.$user_id) }}">
                        ...
                        <div class="form-group row">
                            <label for="old_password" class="col-md-4 col-form-label text-md-right">{{ __('Senha atual') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirmar senha nova') }}</label>
