                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/addClassroom') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="day" type="day" class="form-control{{ $errors->has('day') ? ' is-invalid' : '' }}" name="day" value="{{ old('day') }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="size" type="size" class="form-control{{ $errors->has('size') ? ' is-invalid' : '' }}" name="size" value="{{ old('size') }}" >
